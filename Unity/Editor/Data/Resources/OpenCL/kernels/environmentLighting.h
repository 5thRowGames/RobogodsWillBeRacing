...
float4 EnvCubeMapSample(__global float4 * const env_mipped_cube_texels_buffer, __global int * const env_mip_offsets_buffer,
...
int GenImgExtIdx(const int x, const int y, const int dim)
{
...
float4 FinalGather(__global float4 * const env_mipped_cube_texels_buffer, __global int * const env_mip_offsets_buffer,
