...
Shader "Robogods/Hologram"
{
	Properties
	{
		...
		_LerpController("LerpController", Range( -5 , 5)) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_104_0 = step( ase_vertex3Pos.y , ( _LerpController + -0.01 ) );
			...
			float2 uv_TexCoord126 = i.uv_texcoord * temp_cast_4;
			float2 panner125 = ( 1.0 * _Time.y * float2( 1,0 ) + uv_TexCoord126);
			float4 LineOpacity122 = ( temp_output_98_0 * tex2D( _TextureSample0, panner125 ) );
			clip( ( temp_output_60_0 + temp_output_104_0 + LineOpacity122 ).r - _Cutoff );
		}
...
/*ASEBEGIN
Version=16400
608.8;73.6;925;711;3770.766;2046.629;5.802399;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-2695.503,148.7308;Float;False;Property;_LerpController;LerpController;7;0;Create;True;0;0;False;0;0;0.3704835;-5;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-2106.65,1243.743;Float;False;Constant;_Float0;Float 0;10;0;Create;True;0;0;False;0;-0.01;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-1894.796,1648.598;Float;False;Constant;_Float1;Float 1;12;0;Create;True;0;0;False;0;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;126;-1720.796,1622.598;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;105;-1900.359,1202.883;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;127;-1596.796,1742.598;Float;False;Constant;_Vector0;Vector 0;12;0;Create;True;0;0;False;0;1,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.GetLocalVarNode;108;-1452.389,1029.818;Float;True;93;HologramPart;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;125;-1385.796,1565.598;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;118;-1119.517,1477.766;Float;True;Property;_TextureSample0;Texture Sample 0;11;0;Create;True;0;0;False;0;None;e28dc97a9541e3642a48c0e3886688c5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;113;-856.9901,1072.009;Float;False;Property;_LineColor;Line Color;10;1;[HDR];Create;True;0;0;False;0;0,0,0,0;2.258824,0,4,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;119;-751.8397,1417.204;Float;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;89;-1113.627,-273.9577;Float;False;52;ScanLines;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;122;-476.4275,1438.275;Float;False;LineOpacity;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;114;-172.1062,1225.649;Float;False;Line;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;97;-1641.845,26.41294;Float;False;93;HologramPart;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;66;-616.6648,363.0679;Float;False;62;NormalPart;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;123;-1346.596,323.1422;Float;False;122;LineOpacity;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;50;-619.9485,-76.02919;Float;True;48;Fresnel;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;115;-401.4672,21.43127;Float;False;114;Line;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;116;-185.4672,-45.56873;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;124;-1115.723,421.4425;Float;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=FAE1DF668817378E3C49ADC606D80E5D95061B61